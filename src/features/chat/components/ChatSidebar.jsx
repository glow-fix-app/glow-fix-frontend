...
export default function ChatSidebar({ chats, selectedId, onSelect, isLoading }) {
  return (
    <div className="w-full flex flex-col h-full bg-white">
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          <div className="p-4 text-center text-sm text-text-muted">Loading conversations...</div>
        ) : chats.length === 0 ? (
